...
**Status:** Phases 0 to 8 built and tested (Task 1.7 needs one check on your computer; see its note). Phase 9 (polish and accessibility review), Phase 10 (deployment), and Phase 11 (shared data, later) are still to do.
...
- [x] **1.4 Build the bottom tab bar (Home, Create, My Games, Profile)**
...
- [x] **1.5 Add the screen switcher (router)**
...
- [x] **1.6 Build the Welcome screen**
...
- [ ] **1.7 Prepare Cloudflare settings early** (file written and its settings checked; still needs `npx wrangler dev` run on your computer, because the build environment could not download Wrangler)
...
- [x] **2.1 Build the sample-people data**
...
- [x] **2.2 Build the storage layer (the one file that saves data)**
...
- [x] **2.3 Build the validation rules**
...
- [x] **2.5 Make skill level and position chips work**
...
- [x] **2.6 Validate and save the profile**
...
- [x] **2.7 Show the saved profile when returning**
...
- [x] **3.1 Generate the sample games**
...
- [x] **3.4 Format dates the friendly way**
...
- [x] **3.5 Hide past games and show an empty state**
...
- [x] **4.2 Show all game information**
...
- [x] **4.4 Handle a game that no longer exists**
...
- [x] **5.1 Build the game-rule functions**
...
- [x] **5.2 Make JOIN GAME work from the card**
...
- [x] **5.4 Show FULL for full games**
...
- [x] **5.5 Require a profile before joining**
...
- [x] **5.6 Join and leave from Game Details**
...
- [x] **5.7 Update every screen after every action**
...
- [x] **6.5 Require a profile before creating**
...
- [x] **7.1 Build the "Games I'm Joining" section**
...
- [x] **7.2 Build the "Games I Created" section**
...
- [x] **7.3 Keep My Games up to date**
...
- [x] **8.1 Save everything through the storage layer**
...
- [x] **8.3 Do not duplicate sample games on refresh**
...
- [x] **8.4 Handle damaged or missing saved data**
...
- [x] **8.5 Add a "Reset demo data" control**
